package dev.androidpoet.bitcoin.ui
    ...
    Card(
        ...
        Column(
            ...
            Row(
                ...
                Text(
                    text = "TX: ${transaction.txid.take(16)}...",
            ...
            Row(
                ...
                Column {
                    Text(
                        text = "Inputs: ${transaction.vin.size}",
                        style = MaterialTheme.typography.bodySmall,
                        color = MaterialTheme.colorScheme.onSurface.copy(alpha = 0.7f)
                    )
                    Text(
                        text = "Outputs: ${transaction.vout.size}",
                        style = MaterialTheme.typography.bodySmall,
                        color = MaterialTheme.colorScheme.onSurface.copy(alpha = 0.7f)
                    )
                }
                ...
                Column(horizontalAlignment = Alignment.End) {
                    Text(
                        text = "Fee: ${formatSatoshis(transaction.fee)}",
                        style = MaterialTheme.typography.bodySmall,
                        color = MaterialTheme.colorScheme.onSurface.copy(alpha = 0.7f)
                    )
                    Text(
            ...
            if (transaction.isConfirmed && transaction.status.blockHeight != null) {
                Spacer(modifier = Modifier.height(4.dp))
                Text(
                    text = "Block: ${transaction.status.blockHeight}",
                    style = MaterialTheme.typography.bodySmall,
